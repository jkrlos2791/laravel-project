...
class MantenimientoController extends Controller {
	...
	function limpiarBD( Request $request){
        //Eliminar planillas si el trabajador no existe		  
        $planillas = Planilla::get();
        foreach ($planillas as $planilla) {
            $empleado = Empleado::where('id_trabajador', '=', $planilla->id_trabajador)->first();
            if($empleado==null || $empleado->id_trabajador==null){
                //return dd($empleado);
                $planilla->delete();	
            }  
        } 
        //Eliminar contratos si el trabajador no existe		  
        $contratos = Contrato::get();
        foreach ($contratos as $contrato) {
            $empleado = Empleado::where('id_trabajador', '=', $contrato->id_trabajador)->first();
            if($empleado==null || $empleado->id_trabajador==null){
                $contrato->delete();	
            }  
        } 
