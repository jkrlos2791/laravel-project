		 ...
		 {!! Form::open(array('url'=>'centrocosto/savepublic', 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
...
<div class="col-md-12">
						<fieldset><legend> Centro de Costos</legend>
						     ...
						     class='form-control ' /> 
									  ...
									  <div class="form-group  " >
										<label for="Centro de Costo" class=" control-label col-md-4 text-left"> Centro de Costo </label>
										<div class="col-md-7">
