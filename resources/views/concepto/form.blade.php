...
<div class="sbox">
	...
	<div class="sbox-content"> 	
		...
		<ul class="parsley-error-list">
		 ...
		 {!! Form::open(array('url'=>'concepto/save?return='.$return, 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
<div class="col-md-12">
						<fieldset><legend> Conceptos</legend>
				{!! Form::hidden('itd_id', $row['itd_id']) !!}					
									  <div class="form-group  " >
										<label for="Empresa" class=" control-label col-md-4 text-left"> Empresa </label>
										<div class="col-md-7">
						     ...
						     class='form-control ' /> 
									  ...
									  <div class="form-group  " >
										...
										<div class="col-md-7">
										  <input  type='text' name='tipo' id='tipo' value='{{ $row['tipo'] }}' 
						     class='form-control ' /> 
										 </div> 
										 <div class="col-md-1">
			...
			<div style="clear:both"></div>	
				  ...
				  <div class="form-group">
					...
					<button type="button" onclick="location.href='{{ URL::to('concepto?return='.$return) }}' " class="btn btn-warning btn-sm "><i class="icon-cancel-circle2 "></i>  {{ Lang::get('core.sb_cancel') }} </button>
					</div>	  
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("concepto/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
