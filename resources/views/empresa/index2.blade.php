			...
			<div class="accordion" id="accordionExample">
			  ...
			  <div class="card">
				...
				<div id="collapse5" class="collapse" aria-labelledby="heading5" data-parent="#accordionExample">
				  <div class="card-body">
					<div class="form-group row " >
                        <form action="{{ url('cargarLogo')}}" class="dropzone" id="DropZoneFiddle">
...
@include('empresa/formperiodo')
@include('empresa/formcentrocosto')
<script type="text/javascript" src="{{ asset('jl/core/empresas.js') }}"></script>	
<script>
$(function() {
