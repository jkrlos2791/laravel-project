...
<div class="col-md-12">
						<fieldset><legend> Otros Conceptos</legend>
						     ...
						     class='form-control ' /> 
									  ...
									  <div class="form-group  " >
										<label for="Feriado" class=" control-label col-md-4 text-left"> Feriado </label>
										<div class="col-md-7">
										  <input  type='text' name='feriado' id='feriado' value='{{ $row['feriado'] }}' 
						     class='form-control ' /> 
										 </div> 
										 <div class="col-md-1">
									  ...
									  <div class="form-group  " >
										<label for="Dias Computables" class=" control-label col-md-4 text-left"> Dias Computables </label>
										<div class="col-md-7">
										  <input  type='text' name='dias_computables' id='dias_computables' value='{{ $row['dias_computables'] }}' 
						     class='form-control ' /> 
										 </div> 
										 <div class="col-md-1">
									  ...
									  <div class="form-group  " >
										<label for="Hn" class=" control-label col-md-4 text-left"> Hn </label>
										<div class="col-md-7">
						     ...
						     class='form-control ' /> 
									  ...
									  <div class="form-group  " >
										<label for="Importe Hn" class=" control-label col-md-4 text-left"> Importe Hn </label>
										<div class="col-md-7">
										  <input  type='text' name='importe_hn' id='importe_hn' value='{{ $row['importe_hn'] }}' 
						     class='form-control ' /> 
										 </div> 
										 <div class="col-md-1">
									  ...
									  <div class="form-group  " >
										...
										<div class="col-md-7">
										  <input  type='text' name='base_imponible' id='base_imponible' value='{{ $row['base_imponible'] }}' 
						     class='form-control ' /> 
										 </div> 
										 <div class="col-md-1">
						     ...
						     class='form-control ' /> 
									  ...
									  <div class="form-group  " >
										<label for="Bono" class=" control-label col-md-4 text-left"> Bono </label>
										<div class="col-md-7">
										  <input  type='text' name='bono' id='bono' value='{{ $row['bono'] }}' 
						     class='form-control ' /> 
										 </div> 
										 <div class="col-md-1">
									  ...
									  <div class="form-group  " >
										<label for="Vacaciones" class=" control-label col-md-4 text-left"> Vacaciones </label>
										<div class="col-md-7">
										  <input  type='text' name='vacaciones' id='vacaciones' value='{{ $row['vacaciones'] }}' 
						     class='form-control ' /> 
										 </div> 
										 <div class="col-md-1">
						     ...
						     class='form-control ' /> 
									  ...
									  <div class="form-group  " >
										<label for="Neto Pagar" class=" control-label col-md-4 text-left"> Neto Pagar </label>
										<div class="col-md-7">
										  <input  type='text' name='neto_pagar' id='neto_pagar' value='{{ $row['neto_pagar'] }}' 
						     class='form-control ' /> 
										 </div> 
										 <div class="col-md-1">
						     ...
						     class='form-control ' /> 
									  ...
									  <div class="form-group  " >
										<label for="Jornal" class=" control-label col-md-4 text-left"> Jornal </label>
										<div class="col-md-7">
										  <input  type='text' name='jornal' id='jornal' value='{{ $row['jornal'] }}' 
						     class='form-control ' /> 
										 </div> 
										 <div class="col-md-1">
									  ...
									  <div class="form-group  " >
										<label for="Destajo" class=" control-label col-md-4 text-left"> Destajo </label>
										<div class="col-md-7">
										  <input  type='text' name='destajo' id='destajo' value='{{ $row['destajo'] }}' 
						     class='form-control ' /> 
										 </div> 
										 <div class="col-md-1">
									  ...
									  <div class="form-group  " >
										<label for="Refrigerio" class=" control-label col-md-4 text-left"> Refrigerio </label>
										<div class="col-md-7">
										  <input  type='text' name='refrigerio' id='refrigerio' value='{{ $row['refrigerio'] }}' 
						     class='form-control ' /> 
										 </div> 
										 <div class="col-md-1">
									  ...
									  <div class="form-group  " >
										<label for="Semana Id" class=" control-label col-md-4 text-left"> Semana Id </label>
										<div class="col-md-7">
										  <input  type='text' name='semana_id' id='semana_id' value='{{ $row['semana_id'] }}' 
						     class='form-control ' /> 
										 </div> 
										 <div class="col-md-1">
			...
			<div style="clear:both"></div>	
				  ...
				  <div class="form-group">
					...
					<button type="button" onclick="location.href='{{ URL::to('otrosconceptos?return='.$return) }}' " class="btn btn-warning btn-sm "><i class="icon-cancel-circle2 "></i>  {{ Lang::get('core.sb_cancel') }} </button>
					</div>	  
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("otrosconceptos/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
