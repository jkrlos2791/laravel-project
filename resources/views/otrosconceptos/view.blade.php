...
<div class="sbox ">
	<div class="sbox-title">
		<div class="sbox-tools pull-left" >
	   		<a href="{{ url('otrosconceptos?return='.$return) }}" class="tips btn btn-xs btn-default" title="{{ Lang::get('core.btn_back') }}"><i class="fa  fa-arrow-left"></i></a>
			@if($access['is_add'] ==1)
	   		<a href="{{ url('otrosconceptos/update/'.$id.'?return='.$return) }}" class="tips btn btn-xs btn-default" title="{{ Lang::get('core.btn_edit') }}"><i class="fa  fa-pencil"></i></a>
			@endif 
					
		</div>	

		<div class="sbox-tools " >
			<a href="{{ ($prevnext['prev'] != '' ? url('otrosconceptos/show/'.$prevnext['prev'].'?return='.$return ) : '#') }}" class="tips btn btn-xs btn-default"><i class="fa fa-arrow-left"></i>  </a>	
			<a href="{{ ($prevnext['next'] != '' ? url('otrosconceptos/show/'.$prevnext['next'].'?return='.$return ) : '#') }}" class="tips btn btn-xs btn-default"> <i class="fa fa-arrow-right"></i>  </a>
	...
	<div class="sbox-content" > 	
		...
		<table class="table table-striped table-bordered" >
			<tbody>	
					...
					<tr>
						<td width='30%' class='label-view text-right'>Feriado</td>
						<td>{{ $row->feriado}} </td>
					...
					<tr>
						<td width='30%' class='label-view text-right'>Jornal</td>
						<td>{{ $row->jornal}} </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>Destajo</td>
						<td>{{ $row->destajo}} </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>Refrigerio</td>
						<td>{{ $row->refrigerio}} </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>Semana Id</td>
						<td>{{ $row->semana_id}} </td>
