...
<div class="sbox-tools" >
		@if($access['is_excel'] ==1)
			<a href="{{ URL::to('rentaquinta/download') }}" class="tips btn btn-sm btn-white" title="{{ Lang::get('core.btn_download') }}">
	...
	<div class="sbox-content"> 	
	 ...
	 {!! Form::open(array('url'=>'rentaquinta/delete/', 'class'=>'form-horizontal' ,'id' =>'SximoTable' )) !!}
